...
//#define DESTMAC3	0xce
//#define DESTMAC4	0x82
//#define DESTMAC5	0x2d
//
//#define destination_ip 192.168.106.129
//
...
//    iph->daddr	= inet_addr("192.168.106.129"); // put destination IP address
//    printf("destIP:%.2X\n",iph->daddr);
